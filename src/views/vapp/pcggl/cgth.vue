        ...
        <div class="eo_col">
            ...
            <div class="eo_col_f">
                <div class="eo_row">
                    ...
                    <div class="eo_row_d">
                        <vflow ref="v_flow_cgth" type="采购退货" :app="false"></vflow>
                    </div>
                </div>
            </div>
        </div>
...
<script lang="ts" setup>
    ...
    const addProcessData = async (data: any, idField: string) => {

        v_flow_cgth.value?.clear_list(data[idField]);
        let processData = await v_flow_cgth.value?.process_add_data(data[idField], "-");
    ...
    const onDialogClose_cgth_xx = async (cancel: boolean, data: any, cb: cfunc_boolean) => {
        ...
        if (isAdd) {
            await addProcessData(dataNew, "f_cgth_id");
        }
