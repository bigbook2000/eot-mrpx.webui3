                ...
                <div class="ap_list">
                    ...
                    <div v-for="item in x_data_list" :key="item.f_cgdcp_id"
                        ...
                        <div class="body">
                            ...
                            <div class="row" v-if="props.editMode == 1 || props.editMode == 2">
...
<script lang="ts" setup>
    ...
    const onAdd_cgdcp = () => {
        ...
        v_cgdcp_xx.value?.showDialog("产品信息", cgdcpData, props.fieldArray, true);
    }
