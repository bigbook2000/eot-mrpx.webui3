                        ...
                        <div class="eo_col">
                            ...
                            <div class="eo_col_f">
                                <vtable ref="v_table_dic" 
                                    ...
                                    <el-table-column prop="f_label" label="名称" width="180" show-overflow-tooltip />
                                    <el-table-column prop="f_note" label="描述" width="200" show-overflow-tooltip />
                                    <el-table-column />
                                </vtable>
                            </div>
                        </div>                        
                        ...
                        <div class="eo_col">
                            ...
                            <div class="eo_col_f">
                                <vtable ref="v_table_item" 
                                    ...
                                    id-field="f_dic_id"
                                    @loading="onTableLoading_dic">
                                    <el-table-column prop="f_label" label="名称" width="280" show-overflow-tooltip/>                                    
...
<script lang="ts" setup>
    ...
    onMounted(() => {
        ...
        v_table_dic.value!.load_list_net("/framework/dic/list", {
            "f_dic_pid": 1
        });
    })
    ...
    const onButtonClick_Del_dic = async () => {
        await v_table_dic.value!.remove_data_net_select("/framework/dic/del", (data) => {
            return {
    ...
    const onButtonClick_New_item = () => {
        ...
        v_formd_item.value?.update_list("f_dic_pid", listNew);
    }
    ...
    const onButtonClick_Del_item = async () => {
        await v_table_item.value!.remove_data_net_select("/framework/dic/del", (data) => {
            return {
                "f_dic_id": data["f_dic_id"]
            }
        })
    ...
    const onButtonClick_Create = async () => {
        ...
        let ret = await eocore.post("/framework/dic/create", [{}]);
    ...
    const onTableRowClick_dic = (data: any) => {
        v_table_item.value!.load_list_net("/framework/dic/list", {
    ...
    const onFormdClose_dic = (cancel: boolean, data: any, cb: cfunc_boolean): void => {
        ...
        let insert = (data["f_dic_id"] <= 0);
        v_table_dic.value?.update_data_net(
            "/framework/dic/upd", data, -1, insert, true);
    ...
    const onFormdClose_item = (cancel: boolean, data: any, cb: cfunc_boolean): void => {
        ...
        v_table_item.value!.update_data_net(
            "/framework/dic/upd", data, -1, data["f_dic_id"]<=0, true);
