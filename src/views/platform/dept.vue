...
import TGlobal from "@/logic/TGlobal";
    ...
    const loadTree_dept = async () => {
        ...
        let ret:any = await eocore.post("/framework/dept/list", [{
            "f_dept_pid": TGlobal.userData.dept_id
        }])
        ...
        let expIds = [];
        for (let d of tree) {
            expIds.push(d["f_dept_id"]);
        }
        x_expanded_keys.value = expIds;
    }
    ...
    const onButtonClick_Del = async () => {
        ...
        x_show_loading.value = true;
        let ret: any = await eocore.post("/framework/dept/del", [{
    ...
    const onButtonClick_Index = async () => {
        ...
        x_show_loading.value = true;
        let ret: any = await eocore.post("/framework/dept/index", [{}]);
        x_show_loading.value = false;
    ...
    const onFormdClose_dept = async (cancel: boolean, data: any, cb: cfunc_boolean) => {
        ...
        x_show_loading.value = true;
        let ret: any = await eocore.post("/framework/dept/upd", [{
    ...
    const onFormdClose_deptlist = async (cancel: boolean, data: any, cb: cfunc_boolean) => {
        ...
        x_show_loading.value = true;
        let ret: any = await eocore.post("/framework/dept/parent", [{
