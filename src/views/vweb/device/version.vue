...
<script lang="ts" setup>
    ...
    import version_file from "@/views/vweb/device/version_file.vue"
    import version_config from "@/views/vweb/device/version_config.vue"
    ...
    const onDialogClose_versionfile = async (cancel: boolean, data: any, cb: cfunc_boolean): Promise<void> => {
        ...
        // 读取文件
        let ret = await eocore.post("/common/file/get", [{
