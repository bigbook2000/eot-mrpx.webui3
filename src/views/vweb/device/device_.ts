...
import device_info from "@/views/vweb/device/device_info.vue"
import device_control from "@/views/vweb/device/device_control.vue"
import device_config from "@/views/vweb/device/device_config.vue"
import device_version from "@/views/vweb/device/device_version.vue"
...
const onButtonClick_Add = async () => {
    ...
    let ret = await eocore.post("/common/uuid", [{}]);
