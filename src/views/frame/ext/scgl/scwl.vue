        ...
        <div class="eo_col">
            ...
            <div class="eo_col_f">
                <vtable ref="v_table_kcjy" 
                    ...
                    <el-table-column prop="f_cpsl" label="包装数量" width="120" />
            ...
            <div class="eo_page_bar">
                <el-pagination
                    background
                    @current-change="onPageChange_jyd"
...
<script lang="ts">
/** KeepAlive */
export default { name: "ext_scgl_scwl" }
</script>
...
<script lang="ts" setup>
     ...
     * @param pageIndex 页码
     */
    const onPageChange_jyd = (pageIndex: number) => {
