...
<script lang="ts" setup>
    ...
    const onButtonClick_Add_cgdrk = async () => {
        ...
        v_cgdrk_xx.value?.showDialog(rkcpmxData, m_edit_fields);
    }
    ...
    const onButtonClick_Del_cgdrk = async () => {
        ...
        await v_table_cgdrk.value?.remove_data_proc_select("p_rkcpmx_del", async (data: any) => {
            return {
    ...
    const onButtonClick_Upd_cgdrk = () => {
        ...
        v_cgdrk_xx.value?.showDialog(kcmxrkData, m_edit_fields);
    }
