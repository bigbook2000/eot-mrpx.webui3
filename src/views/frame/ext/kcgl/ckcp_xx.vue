    ...
    <vdialog ref="v_dialog"
        ...
        <div class="eo_form">
            <div class="cell eo_w2">
                ...
                <div class="input">
                    <el-input v-model="x_data_ckcpmx['f_ckdh']" style="width:100%" disabled>
                    </el-input>
                </div>
            </div>            
            <div class="cell eo_w2">
                ...
                <div class="input">
                    <el-input v-model="x_data_ckcpmx['f_kcbh']" style="width:100%"
            ...
            <div class="cell eo_w2">
                ...
                <div class="input">
                    <el-input v-model="x_data_ckcpmx['f_cpbm']" style="width:100%"
            ...
            <div class="cell eo_w2">
                ...
                <div class="input">
                    <el-input v-model="x_data_ckcpmx['f_cpmc']" style="width:100%"
                        maxlength="50" disabled></el-input>
                </div>
            </div>
            ...
            <div class="cell eo_w2">
                ...
                <div class="input">
                    <el-input v-model="x_data_ckcpmx['f_wlgs_id_s']" style="width:100%"
            ...
            <div class="cell eo_w2">
                ...
                <div class="input">
                    <el-input-number v-model="x_data_ckcpmx['f_ckdj']" :precision="2" :min="0" 
            ...
            <div class="cell eo_w2">
                ...
                <div class="input">
                    <el-input v-model="x_data_ckcpmx['f_wldh']" style="width:100%"
            ...
            <div class="cell eo_w2">
                <div class="label_n">库存成本<span style="color:red;">*</span></div>
                <div class="input">
                    <el-input-number v-model="x_data_ckcpmx['f_cpdj']" :precision="2" :min="0" 
                        placeholder="" style="width: 100%" 
                        :disabled="true"
                        @change="onNumberChange_jszj" />
                </div>
            ...
            <div class="cell eo_w4">
                ...
                <div class="input">
                    <vdic style="width:100%" dic="产品仓库" :all="false" field="value"
                        v-model="x_data_ckcpmx['f_hwck']" :disabled="true" />
                </div>
            </div>
            <div class="cell eo_w4">
                <div class="label_n">出库时间</div>
                <div class="input">
                    <el-input v-model="x_data_ckcpmx['f_rksj_s']" style="width:100%"
            ...
            <div class="cell eo_w4">
                ...
                <div class="input">
                    <el-input v-model="x_data_ckcpmx['f_rkzt_s']" style="width:100%"
                        maxlength="200" disabled></el-input>
                </div>
            </div>
            <div class="cell eo_w4">
                ...
                <div class="input">
                    <el-input v-model="x_data_ckcpmx['f_kgy_id_s']" style="width:100%"
                        maxlength="200" disabled></el-input>
                </div>
            </div>
            ...
            <div class="cell eo_w100">
                ...
                <div class="input">
                    <el-input v-model="x_data_ckcpmx['f_beizhu']" style="width:100%"
...
<script lang="ts" setup>
    ...
    import kczl_list from "@/views/frame/ext/kcgl/kczl_list.vue"
    ...
    // 表单数据
    const x_data_ckcpmx: any = reactive({});
    ...
    const showDialog = (data: any, fieldArray: string[]) => {
        ...
        x_edit_upd.value = eocore.check_id(data, "f_kcmxck_id");

        // 先打开对话框
        v_dialog.value!.show_dialog(undefined);

        // 创建一个副本并更新响应式数据
        Object.assign(x_data_ckcpmx, data);
    }
    ...
    const onNumberChange_jszj = () => {
        ...
        let cpsl = eocore.to_float(x_data_ckcpmx['f_cpsl'] || 0);
        let cpdj = eocore.to_float(x_data_ckcpmx['f_cpdj'] || 0);
        x_data_ckcpmx['f_cpzj'] = Number((cpsl * cpdj).toFixed(2));
    }
    /**
     * 自动计算单价
     */
    const onNumberChange_jsdj = () => {
        ...
        let cpsl = eocore.to_float(x_data_ckcpmx['f_cpsl'] || 0);
        let cpzj = eocore.to_float(x_data_ckcpmx['f_cpzj'] || 0);

        if (cpsl <= 0.0) {
            cpsl = 1.0;
            x_data_ckcpmx['f_cpsl'] = cpsl;
        }

        x_data_ckcpmx['f_cpzj'] = Number((cpzj / cpsl).toFixed(2));
    }    
    ...
    const onDialogClose = async (cancel: boolean, data0: any, cb: cfunc_boolean) => {
        ...
        const data = x_data_ckcpmx;
        const isAdd = data["f_kcmx_id"] == 0;
        if (!eocore.check_id(data, "f_cpdy_id")) {
            eocore.show_error("请选择库存");
            cb(false); return;            
        }

        if (!eocore.check_id(data, "f_ckd_id")) {
    ...
    const onInputOpen_kcmx = () => {
        v_kczl_list?.value?.show_dialog(x_data_ckcpmx);
    }
    const onListSelect_kczl = (cancel: boolean, data: any, cb: cfunc_boolean) => {
        ...
        x_data_ckcpmx['f_kcmx_id'] = data['f_kcmx_id'];
        x_data_ckcpmx['f_kcbh'] = data['f_kcbh'];
        x_data_ckcpmx['f_cpdj'] = data['f_cpdj']; // 使用产品定义中的价格作为默认单价
    ...
    const onListSelect_wlgs = (cancel: boolean, data: any, cb: cfunc_boolean) => {
        ...
        x_data_ckcpmx['f_wlgs_id_s'] = data['f_gsmc'];
        x_data_ckcpmx['f_wlgs_id'] = data['f_wlgs_id'];
