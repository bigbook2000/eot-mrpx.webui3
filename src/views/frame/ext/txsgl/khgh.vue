...
<script lang="ts">
/** KeepAlive */
export default { name: "ext_xsgl_khgh" }
</script>
...
<script lang="ts" setup>
    ...
    } = useKhglCommon(v_table_khgl, v_khgl_ex, v_kehu_xx, TLogic.ghbzCodes["公海"])
    ...
    const onDialogClose_kehu_xx = (cancel: boolean, data: any, cb: cfunc_boolean) => {
