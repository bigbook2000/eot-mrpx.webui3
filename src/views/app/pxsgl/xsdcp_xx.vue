                        ...
                        <div class="cell eo_w100">
                            ...
                            <div class="input">
                                <el-input v-model="x_data_xsdcp['f_beizhu']" style="width:100%"
                                    maxlength="100" placeholder="请输入备注" :disabled="!x_edit_fields['f_beizhu']" />
                            </div>
                        </div>
                    </div>
...
<script lang="ts" setup>
    ...
    import cpdy_list from "@/views/app/pkcgl/cpdy_list.vue"
     ...
     * 对话框关闭事件
     */
    const onDialogClose = async (cancel: boolean, _tag: any, cb: cfunc_boolean) => {
