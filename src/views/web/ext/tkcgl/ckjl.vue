<template>
    ...
    <div class="eo_page" v-loading="x_show_loading">    
        <div class="eo_col">
            <div class="eo_tool_bar">
                <div class="eo_form">
                    ...
                    <div class="cell eo_w200p">
                        ...
                        <div class="input">
                            <vdic style="width:100%" dic="入库类别" :all="true" field="value"
                ...
                <div class="eo_form">
                    ...
                    <div class="cell">
                        <div class="input_w">
                            <el-button type="primary" class="eo_w80p" @click="onButtonClick_Load_rkjl">查找</el-button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            -->
            <div class="eo_col_f">
                <vtable ref="v_table_rkjl" 
                    name="入库记录"
                    id-field="f_kcmxrk_id"
                    @loading="onTableLoading"
                    :on-item="onTableItem_rkjl"
                    @row-click="onTableRowClick_rkjl">
                    ...
                    <el-table-column prop="f_kgy_id_s" label="库管员" width="140" />
            ...
            <div class="eo_page_bar">
                <el-pagination
                    background
                    @current-change="onPageChange_rkjl"
...
<script lang="ts">
/** KeepAlive */
export default { name: "ext_kcgl_ckjl" }
</script>
...
<script lang="ts" setup>
    ...
    const v_table_rkjl = ref<t_table>();
    ...
    onMounted(async () => {
        await netLoad_rkjl_query(-1);
    });


    const netLoad_rkjl_query = async (pageIndex: number = -1) => {
    ...
    const onTableRowClick_rkjl = (data: any) => {
    }

    const onButtonClick_Load_rkjl = () => {
        netLoad_rkjl_query(-1);
    }
     ...
     * @param pageIndex 页码
     */
    const onPageChange_rkjl = (pageIndex: number) => {
        x_page_index.value = pageIndex;
        netLoad_rkjl_query(pageIndex);
    }
