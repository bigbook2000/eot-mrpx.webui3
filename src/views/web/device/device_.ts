...
import device_control from "@/views/web/device/device_control.vue"
import device_config from "@/views/web/device/device_config.vue"
import device_version from "@/views/web/device/device_version.vue"
